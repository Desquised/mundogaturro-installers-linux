...
## Mundo Gaturro Desktop (Linux Native)
Aplicación de escritorio para Mundo Gaturro rediseñada para ejecutarse de forma nativa en sistemas Linux. Este port utiliza ingeniería inversa sobre el cliente oficial para garantizar compatibilidad con el motor original y el plugin Flash (PPAPI) sin necesidad de emuladores.
...
- [Descargar Portable (.AppImage)](https://github.com/Desquised/mundogaturro-installers-linux/blob/assets/bin/mundogaturro-portable-linux86.AppImage?raw=true) - Ejecutable portable para cualquier distribución de Linux de 64 bits.
...
- Una vez instalado el gestor, haz clic derecho sobre el archivo `.deb` y selecciona **"Abrir con Instalador de Software"**.
...
- Soporte oficial del juego: info@mundogaturro.com
